...
- The timeline of elections (announcement → voting → counting → results)
...
- Common election terms (constituency, candidate, manifesto, exit poll, etc.)
...
- When explaining timelines, be specific about typical durations"""
